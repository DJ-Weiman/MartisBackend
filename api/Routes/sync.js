												...
												tables :[
													...
													},
													{
														...
														schema: [
															...
															{constraint:"user_ibfk_1", value:"FOREIGN KEY (RoleID) REFERENCES role (RoleID)"}
														],
														values: userData
													},
													{
														...
														schema: [
															...
															{column:"UserID", value: "TEXT KEY NOT NULL"},
															{column:"PIN", value:"TEXT NOT NULL"},
															{constraint: "device_ibfk_1", value:"FOREIGN KEY (UserID) REFERENCES user(UserID)"}
														],
														values: deviceData
													},
													{
														...
														schema: [
															...
															{constraint:"repair_ibfk_2", value:"FOREIGN KEY (EngineerID) REFERENCES user(UserID)"},
															{constraint:"repair_ibfk_1", value:"FOREIGN KEY (AssetID) REFERENCES asset(AssetID)"}
														],
														values: repairData
													},
													{
														...
														schema: [
															...
															{constraint:"roleaccess_ibfk_1", value: "FOREIGN KEY (RoleID) REFERENCES role(RoleID)"},
															{constraint:"roleaccess_ibfk_2", value: "FOREIGN KEY (AccessID) REFERENCES access(AccessID)"}
														],
													...
													},
													{
														...
														schema: [
															...
															{constraint: "testmodule_ibfk_1", value: "FOREIGN KEY (SupervisorID) REFERENCES user (UserID)"}
														],
