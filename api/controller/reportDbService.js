...
class Dbservice {
	...
	async getReportDetails(inspectorID, InitialDate, FinalDate) {
		try {
			const response = await new Promise((resolve, reject) => {
				const query = `
				SELECT t.TestID, t.InspectorID, t.DateCompleted, a.Division, a.SubDivision, a.NearestMilePost, u.Region, t.Result, u.Email, u.Name, t.comments
	...
	async getAssetReportDetails(assetID, InitialDate, FinalDate) {
		try {
			const response = await new Promise((resolve, reject) => {
				const query = `
				SELECT a.Status,a.Region, t.Result,a.GPSLatitude, a.GPSLongitude, t.TestID, t.InspectorID, t.DateCompleted, a.Division, a.SubDivision, a.NearestMilePost, t.comments 
				from asset a, test t 
				WHERE a.AssetID = t.AssetID AND t.AssetID = ? 
